...
public struct PedometerLibrary {
    ...
    @MainActor public static func makeStepTrackingViewModel(context: NSManagedObjectContext) -> StepTrackingViewModel {
    ...
    @MainActor public static func makeAchievementViewModel(context: NSManagedObjectContext) -> AchievementViewModel {
